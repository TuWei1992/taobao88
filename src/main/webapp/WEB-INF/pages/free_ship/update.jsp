...
<div class="page-header">
  <h4><span class="label label-primary">Редактирование рекомендации (бесплатная доставка)</span></h4>
</div>		
			<jsp:include page="../partials/errors.jsp"/>
			
			<form role="form" method="POST" accept-charset="utf-8" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/pageRedactor/freeShip/updateRecomendation/doUpdate">
					...
					<div class="form-group">
						<label class="input" for="rPhoto">Фото</label> <input type="file" id="rPhoto"
							name="rPhoto">
					</div>
