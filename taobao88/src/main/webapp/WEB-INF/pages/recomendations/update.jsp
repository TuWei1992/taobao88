...
<head>
	<meta charset="utf-8">
	<title>Update Recomendation</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="page-header">
  				<h1>Редактор <small>изменение рекомендации</small></h1>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<form role="form" method="POST" accept-charset="utf-8" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/pageRedactor/updateRecomendation/doUpdate">
					...
					<div class="form-group">
						<button type="submit" role="button" class="btn btn-success">Обновить</button>
					</div>
			</form>
			</div>
		</div>
