...
<div class="page-header">
  <h4><span class="label label-primary">Добавление способа оплаты</span></h4>
</div>
	<jsp:include page="../partials/errors.jsp"/>
	<form role="form" method="POST" accept-charset="utf-8" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/paymentMethods/create/doCreate">
					...
					<div class="form-group">
						...
						<textarea name="methodDescription"></textarea>
					</div>
