...
public class PageRedactorController extends MainController {
    ...
    public String updateRecomendation(@RequestParam ("id") int id,
    		                          Model model) {
    	
    	Recomendation rec = recomendationService.getRecomendationById(id);
    	model.addAttribute("rec", rec);
    	return "recomendationUpdate";
    }
...
//    	}
    ...
    public String updateTopMenu(@RequestParam ("id") int id,
    						    Model model) {
    ...
    public String viewTopMenu(@RequestParam ("id") int id, 
    						  Model model) {
    ...
    public String previewTopMenu(@RequestParam ("menuDescription") String menuDescription,
    						     Model model) {
    	TopMenu topMenu = new TopMenu();
    	topMenu.setMenuDescription(menuDescription);
    	model.addAttribute("topMenu", topMenu);
